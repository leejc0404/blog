...
⛔ **앱전용 화면 판정 (2026-08-09 신설)**: 이 루틴은 **브라우저만 조작**한다. 모바일 앱 안에서만 보이는 화면은 로그인 여부와 무관하게 캡처 불가다.
· **판정 질문: "이 자료가 웹 브라우저에서 보이는가?"** 아니오면 [4g]를 시도하지 말고 즉시 반려한다 (실측 #80 그늘로 앱, 2026-08-09 — 시도 자체가 낭비였다)
