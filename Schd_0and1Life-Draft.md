...
(로컬 **C:\Users\win\Documents\Claude\pw.txt** 의 ONEANDZERO_WP_APP_PASSWORD 값을 사용한다. — v1.29: `.claude` 폴더는 보호 경로라 세션에 연결 불가하여 Documents\Claude로 이전. 구 위치 `.claude\blog\pw.txt`는 폴백으로만 시도)
